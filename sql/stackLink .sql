...
CREATE TABLE project_apply (
    ...
    FOREIGN KEY(user_id) REFERENCES users(id) ON DELETE CASCADE, -- 지원자 데이터 삭제 시 함께 삭제
    FOREIGN KEY(project_id) REFERENCES project(id) ON DELETE CASCADE -- 프로젝트 공고 삭제 시 함께 삭제
);
...
CREATE TABLE project_tech (
    ...
    FOREIGN KEY(tech_id) REFERENCES tech(id) ON DELETE CASCADE, -- 기술 데이터 삭제 시 함께 삭제
    FOREIGN KEY(project_id) REFERENCES project(id) ON DELETE CASCADE -- 프로젝트 공고 삭제 시 함께 삭제
);
