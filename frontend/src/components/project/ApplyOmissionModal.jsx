...
const ApplySuccessModal = ({displayOption}) => {
    ...
    const toggleModal = () => {
        document.getElementById("applyOmissionModal").className = "hidden";
        location.reload();
    }

    return (
        <div id="applyOmissionModal" className={displayOption} className="fixed inset-0 bg-black/50  flex items-center justify-center">
